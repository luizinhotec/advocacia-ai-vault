...
- **Acolhedor e humanizado:** próximo, atendimento individualizado.
- **Sóbrio:** sem agredir, sem sensacionalismo, sem promessa de resultado.
- **Moderno/tecnológico:** o escritório se apresenta como atual e tecnológico.

Resumo para o agente: **claro, didático e acolhedor, com seriedade profissional**
— exatamente o tom que respeita as regras da OAB (informar, não captar/prometer).

## Formatos de conteúdo (a explorar)
- Posts de "dica jurídica" a partir de dúvidas reais dos clientes (já é a prática).
- Explicações de benefícios previdenciários (aposentadoria, BPC/LOAS, revisões).
- Alertas ao consumidor (cobrança indevida, produto com defeito, golpes).
- Vídeo curto educativo (base para avatar/voz na Fase 3).
...
Relacionado: [[institucional]] · [[areas-de-atuacao]] · [[faq]] · [[fluxo-de-atendimento]]
